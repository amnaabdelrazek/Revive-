      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'الرسائل المرسلة من خلال الموقع.',
            'معلومات الجهاز.',
        ...
        {
          heading: 'سياية الإلغاء',
          items: [
            'يمكنك إلغاء الحجز قبل موعد المحاضرة ب 8 ساعات وفقًا للسياسة الموضحة أثناء الحجز.',
            'يتم استرجاع المبلغ بعد إلغاء الحجز وفقًا لسياسة الإلغاء بعد 14 يومًا من الالغاء.',
          ],
        },
        {
          heading: 'حقوقك',
        ...
        {
          heading: 'التواصل',
          body: 'لأي أسئلة متعلقة بالخصوصية، يمكنك التواصل معنا من خلال قسم الدعم داخل الموقع.',
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          heading: 'ملاحظة مهمة',
          body: 'على الرغم من أننا نعمل باستمرار على تحسين إجراءات الأمان، لا يمكن لأي خدمة إلكترونية ضمان الأمان بنسبة 100%. لذلك نشجع جميع المستخدمين على اتباع ممارسات أمان جيدة أثناء استخدام الموقع.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          items: [
            'يهدف الموقع إلى دعم الأفراد خلال رحلة التعافي.',
            'Revive ليس بديلًا عن العلاج الطبي أو النفسي.',
            'يتحمل المستخدم مسؤولية دقة المعلومات التي يقدمها.',
            'قد يؤدي سوء استخدام الموقع أو محاولة تعطيل عمله إلى إيقاف الحساب.',
            'يبقى المستخدم مسؤولًا عن الحفاظ على سرية بيانات حسابه.',
            'يحتفظ Revive بالحق في تحديث أو تعديل هذه الشروط عند الحاجة، ويعد استمرار استخدام الموقع قبولًا لأي تحديثات.',
          ],
        },
      ],
    },
